...
if __name__ == "__main__":
    ...
    print(f"\nQueue Flow:")
    print(f"  Step 1 → tshirt_model detects tshirt (with color class)")
    print(f"  Step 2 → Crop tshirt region → HSV color analysis")
    print(f"  Step 3 → cap_model detects cap presence")
    print(f"  Step 4 → Crop cap region → HSV color analysis")
    print(f"\nValues returned SEPARATELY for tshirt and cap ✅")
